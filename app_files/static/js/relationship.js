...
d3.json("http://127.0.0.1:5000/data").then(function(data){
   ...
   //filter data on age
    ...
    // document.getElementById("sentenceDiv3").innerHTML = "You are in the bottom 25% if your relationship is less than " + Quart_25 + ". The second quartile is between " + Quart_25 + " and " + Quart_50 + " . The third quartile is between " + Quart_50 + " and " + Quart_75 + ". The fourth quartile is above " + Quart_75 + ".</h2>";
});
